...
class RAConfig:
    def __init__(self, serial_port: str):
        ...
        # Servo barrier of angle
        # self.base_min_angle = 600
        # self.base_max_angle = 2400
        # self.shoulder_min_angle = 800
        # self.shoulder_max_angle = 1900
        # self.elbow_min_angle = 700
        # self.elbow_max_angle = 2200
        # self.effector_min_angle = 700
        # self.effector_max_angle = 2400
        # self.gripper_min_angle = 1020
        # self.gripper_max_angle = 1700
        ...
        # Backlash approximate number to multiply
        # self.backlash = 0.066672
    ...
    def move(self, x: float, y: float, z: float, speed: int=700, effector_horizontal_degree: float=90):
        ...
        # Calculate effector degree before z axis correction
        # _, _, _, effector_degree = self.inverse_kinematics(x, y, z)

        # Fix backlash of z axis
        # z += y * self.backlash
        ...
        # Initialize SSC-32U board
        # ser = Serial(self.serial_port, self.baud_rate)
        ...
        # ser.write(f'#{self.base_pin} P{base_angle} S{speed} #{self.shoulder_pin} P{shoulder_angle} S{speed} #{self.elbow_pin} P{elbow_angle} S{speed} #{self.effector_pin} P{effector_angle} S{speed}\n'.encode())
    ...
    def gripper(self, state: bool=False, gripper_degree: float=180, max_strength: int=20):
        ...
        # Initialize SSC-32U board
        # ser = Serial(self.serial_port, self.baud_rate, timeout=0.1)
